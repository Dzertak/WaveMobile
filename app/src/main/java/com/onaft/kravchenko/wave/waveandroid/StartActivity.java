...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean hasAuthorize = sp.getBoolean(ConstantManager.HAS_AUTHORIZE, false);
        if (!hasAuthorize) {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Call<Account> responseCall = mDataManager.authorize(email,password);
            responseCall.enqueue(new Callback<Account>() {
                @Override
                public void onResponse(Call<Account> call, Response<Account> response) {
                    showProgress(false);
                    e.putBoolean(ConstantManager.HAS_AUTHORIZE,true);
                    e.apply();
                    mDataManager.getmPreferencesManager().saveAccount(response.body());
                    Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                    finish();
                ...
                public void onFailure(Call<Account> call, Throwable t) {
                    showProgress(false);
                    Toast.makeText(StartActivity.this, "Логин или пароль не верны!", Toast.LENGTH_SHORT).show();
                    t.printStackTrace();
                }
            });
